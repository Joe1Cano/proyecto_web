...
<body>
  <div id="contenedor">
    ...
    <div id="navbar" class="sidenav">
      ...
      <a href="#"><span class="bi bi-music-note-list"></span> Playlists</a>
...
<footer>
            ...
            <div class="footer-content">
                <button id="like"><i class="bi bi-heart"></i></button>
                <label>
                    <input type="checkbox" id="repeat">
                    <span class="bi bi-repeat" id="rep"></span>
                </label>
                <button id="ant" onclick="beforeSong()"><i class="bi bi-rewind-fill"></i></button>
                <button id="play" onclick="playSound()"><i class="bi bi-play-circle-fill"></i></button>
                <button id="pause" onclick="pauseSound()"><i class="bi bi-pause-circle-fill"></i></button>
                <button id="sig" onclick="nextSong()"><i class="bi bi-fast-forward-fill"></i></button>
                <label>
